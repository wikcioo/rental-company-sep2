...
public class ModelManager implements Model {
  ...
  @Override public void addEquipment(Equipment equipment)
  ...
  @Override public void approveReservation(Reservation reservation)
      throws RemoteException {
    reservation.approve();
    support.firePropertyChange(RESERVATION_LIST_CHANGED, null, reservationList);
  }

  @Override public void toggleAvailability(Equipment equipment)
      throws RemoteException {
  ...
  @Override public void editEquipment(Equipment oldEquipment,
  ...
  @Override public void addReservation(User user, Equipment equipment,
